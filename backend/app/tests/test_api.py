...
from app.models.entities import OrcaProfile, Sighting
...
def test_can_set_friend_orca_and_read_journey():
    with TestClient(app) as client:
        ...
        set_resp = client.post(
            "/api/me/friend-orca",
            json={"user_name": "demo", "orca_profile_id": first_id},
        )
        ...
        journey = client.get("/api/me/friend-orca/journey?user_name=demo")
...
def test_journey_uses_strict_explicit_pod_tags():
    with TestClient(app) as client:
        ...
        set_j = client.post(
            "/api/me/friend-orca",
            json={"user_name": "demo", "orca_profile_id": j_orca_id},
        )
        assert set_j.status_code == 200
        j_journey = client.get("/api/me/friend-orca/journey?user_name=demo&from=2025-02-01T00:00:00&to=2025-02-01T23:59:59")
        ...
        set_b = client.post(
            "/api/me/friend-orca",
            json={"user_name": "demo", "orca_profile_id": biggs_orca_id},
        )
        assert set_b.status_code == 200
        b_journey = client.get("/api/me/friend-orca/journey?user_name=demo&from=2025-02-01T00:00:00&to=2025-02-01T23:59:59")
